    ...
    angular.module("ion-datetime-picker", ["ionic"]).directive("ionDatetimePicker", function () {
        return {
            ...
            controller: ["$scope", "$ionicPopup", "$ionicPickerI18n", "$timeout", function (e, t, n, i) {
                e.i18n = n, e.bind = {}, e.rows = [0, 1, 2, 3, 4, 5], e.cols = [1, 2, 3, 4, 5, 6, 7], e.weekdays = [0, 1, 2, 3, 4, 5, 6], e.showPopup = function () {
                    t.show({
                        ...
                        buttons: [{
                            text: e.buttonOk || e.i18n.ok, type: "button-positive", onTap: function () {
                                e.commit()
                            }
                        }, {
                    ...
                    e.year = e.dateEnabled ? t.getFullYear() : 0, e.month = e.dateEnabled ? t.getMonth() : 0, e.day = e.dateEnabled ? t.getDate() : 0, e.hour = e.timeEnabled ? t.getHours() : 0, e.minute = e.timeEnabled ? t.getMinutes() : 0, e.second = e.secondsEnabled ? t.getSeconds() : 0, o()
                };
                var o = function () {
                ...
                e.changeBy = function (t, n) {
                    if (+t) {
                        ...
                        e[n] += +t, "month" !== n && "year" !== n || (e.day = Math.min(e.day, a(e.year, e.month))), o()
                    }
                }, e.change = function (t) {
                    var n = e.bind[t];
                    n && "meridiem" === t ? (n = n.toUpperCase(), "AM" === n && "PM" === e.meridiem ? e.hour -= 12 : "PM" === n && "AM" === e.meridiem && (e.hour += 12), o()) : (+n || "0" === n) && (e[t] = +n, "month" !== t && "year" !== t || (e.day = Math.min(e.day, a(e.year, e.month))), o())
